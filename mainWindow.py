...
def window(controller):
    ...
    photo = PhotoImage(file ='C:\\Users\\dell\\OneDrive\\Desktop\\ST\\ST4008CEM\\artBoards\\icon.png') 
    window.wm_iconphoto(False, photo)
    window.geometry("1280x800")
    
    bgImage = PhotoImage(file='C:\\Users\\dell\\OneDrive\\Desktop\\ST\\ST4008CEM\\artBoards\\background.png')
    ...
    learnToUse = Label(window,text="Generate A Model",font=('Quicksand',18),background='#ffffff',foreground='#7066D4',cursor="hand1")
    ...
    generateAModel = Label(window,text="Browse Models",font=('Quicksand',18),background='#ffffff',foreground='#7066D4',cursor="hand1")
    ...
    browseModels = Label(window,text="Manage Preferences",font=('Quicksand',18),background='#ffffff',foreground='#7066D4',cursor="hand1")
    ...
    account = Label(window,text="Account",font=('Quicksand',18),background='#ffffff',foreground='#7066D4',cursor="hand1")
    ...
    logoImg = PhotoImage(file='C:\\Users\\dell\\OneDrive\\Desktop\\ST\\ST4008CEM\\artBoards\\logo-resized.png')
